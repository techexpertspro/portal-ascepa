...
export const mockAbout: About = {
  banner: {
    ...
    description:
      'banner quem somos da Associação de e para Cegos do Pará (ASCEPA)',
  },
  about: {
    title: 'quem somos',
    description:
      'A Associação de e para Cegos do Pará (ASCEPA), fundada em 12 de maio de 2000, foi criada com o propósito de fortalecer o movimento de deficientes visuais, propondo e viabilizando ações em busca da melhoria da qualidade de vida deste segmento.',
  },
  mission: {
    title: 'missão',
    description:
