...
export class ThemeToggleComponent {
  @ViewChild('toggleSwitch') private readonly toggleSwitch!: MatSlideToggle;
  ...
  /**
   * Manipula o evento de alternância do tema
   */
  ...
  /**
   * Altera os svg's de on e off do mat-slide-toggle para os svg de lua e sol respectivamente`.
   */
  private updateIcons(): void {
    const onSVG: SVGPathElement = this.toggleSwitch[
      '_elementRef'
    ].nativeElement.querySelector('.mdc-switch__icon--on path');
    const offSVG: SVGPathElement = this.toggleSwitch[
      '_elementRef'
    ].nativeElement.querySelector('.mdc-switch__icon--off path');
